...
// Twitter struct should be named the same as the Plugin
type Twitter struct {
	// Twitter for a mandatory option to set a tag
	...
	// Twitter of passing a duration option allowing the format of e.g. "100ms", "5m" or "1h"
...
func (m *Twitter) Gather(acc telegraf.Accumulator) error {
